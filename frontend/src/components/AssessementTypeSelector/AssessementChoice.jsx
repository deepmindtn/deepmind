...
const AssessmentChoice = ({ onSelect }) => {
  const options = [
    {
      ...
      description:
        "Let our AI architect build a high-conversion assessment tailored to your specific goals and target audience.",
      badge: "Most Popular",
    ...
    },
    {
      ...
      description:
        "Take full control. Build manual questions, upload existing files, and customize every logic jump yourself.",
      badge: "Pro Control",
      theme: COLORS.primary,
      bg: COLORS.primaryLight,
    },
  ...
  return (
    <div className="assessment-choice-container" style={styles.container}>
      ...
      <div
        className="assessment-choice-main-wrapper"
      ...
      >
          ...
          {options.map((option) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className="icon-bounce assessment-choice-icon-box"
                    style={styles.iconBox(option.bg)}
                  >
                    <Icon size={32} color={option.theme} />
                  </div>
                  <span
                    className="assessment-choice-badge"
                    style={styles.badge(option.bg, option.theme)}
                  >
                    {option.badge}
                  </span>
                </div>
        ...
        <div className="assessment-choice-divider" style={styles.footerDivider}>
          <span
            className="assessment-choice-divider-text"
            style={{
              position: "absolute",
              top: "50%",
              left: "50%",
        ...
        {/* Features Row */}
        <div
          className="assessment-choice-features-grid"
          style={{
            display: "grid",
        ...
        >
          {features.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className="assessment-choice-feature-item"
              ...
              >
                ...
                />
                <div
                  className="assessment-choice-feature-title"
                  style={{
                    fontWeight: "700",
                    fontSize: "14px",
                    color: COLORS.textPrimary,
                ...
                <div
                  className="assessment-choice-feature-desc"
