                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin:30px auto;">
                                <tr>
                                    <td align="center" style="border-radius:8px; background-color:#10b981;">
                                        <a href="{{inviteLink}}" target="_blank" style="display:inline-block; padding:14px 32px; font-family:Arial, sans-serif; font-size:16px; color:#ffffff; text-decoration:none; font-weight:bold; border-radius:8px; border:1px solid #10b981;">
...
<body style="margin:0; padding:0; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; background-color:#f8fafc;">
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#f8fafc; padding:40px 0;">
        ...
        # ------------------------------
        # 3. Assessment Assignment (Employee)
        # ------------------------------
        {
...
<body style="margin:0; padding:0; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; background-color:#f8fafc;">
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#f8fafc; padding:40px 0;">
                    ...
                    <tr>
                        <td style="padding:20px 40px 40px 40px; color:#1f2937; line-height:1.6; font-size:16px;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin:30px auto;">
                                <tr>
                                    <td align="center" style="border-radius:8px; background-color:#10b981;">
                                        <a href="{{assessmentLink}}" target="_blank" style="display:inline-block; padding:14px 32px; font-family:Arial, sans-serif; font-size:16px; color:#ffffff; text-decoration:none; font-weight:bold; border-radius:8px; border:1px solid #10b981;">
                                            Start Assessment
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0 0 20px 0; color:#6b7280;">
                                Please complete the assessment by the assigned deadline. If you encounter any issues or did not expect this email, contact support immediately.
                            </p>
                            <p style="margin:20px 0 0 0; font-size:14px; color:#9ca3af;">
                                Best regards,<br>
        ...
        # ------------------------------
        # 4. Candidate Assessment Invitation (Candidate, updated)
        # ------------------------------
        {
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding:20px 40px 40px 40px; color:#1f2937; line-height:1.6; font-size:16px;">
                            <h1 style="margin:0 0 20px 0; font-size:24px; font-weight:800; color:#10b981;">Hello {{firstName}},</h1>
                            <p style="margin:0 0 20px 0; color:#475569;">
                                You have been invited to complete an assessment: <strong>{{templateName}}</strong>. Completing this assessment will help us better understand your skills and suitability for the role.
                            </p>
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin:30px auto;">
                                <tr>
                                    <td align="center" style="border-radius:8px; background-color:#10b981;">
                            ...
                            <p style="margin:0 0 20px 0; color:#6b7280;">
                                Please complete the assessment by the assigned deadline. If you did not expect this email or encounter any issues, contact our support team immediately.
                            </p>
                            <p style="margin:20px 0 0 0; font-size:14px; color:#9ca3af;">
                                Good luck!<br>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding:20px 40px 40px 40px; color:#1f2937; line-height:1.6; font-size:16px;">
                            <h1 style="margin:0 0 20px 0; font-size:24px; font-weight:800; color:#10b981;">Hello {{firstName}},</h1>
                            <p style="margin:0 0 20px 0; color:#475569;">
                                You have been assigned a new survey: <strong>{{surveyTitle}}</strong>. Your feedback is important to help us improve processes and better understand employee satisfaction.
                            </p>
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin:30px auto;">
                                <tr>
                                    <td align="center" style="border-radius:8px; background-color:#10b981;">
                            ...
                            <p style="margin:0 0 20px 0; color:#6b7280;">
                                Please complete the survey by the assigned deadline. If you did not expect this email or encounter any issues, contact our support team immediately.
                            </p>
                            <p style="margin:20px 0 0 0; font-size:14px; color:#9ca3af;">
                                Thank you!<br>
                                <strong>HR Team</strong>
